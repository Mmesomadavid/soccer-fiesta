    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mt-16">
          ...
          >
            {/* Decorative Elements */}
            <div className="absolute -left-8 top-8 w-32 h-32 sm:w-48 sm:h-48 bg-yellow-300/10 rounded-lg transform -rotate-12 blur-2xl" />
            <div className="absolute -right-8 bottom-8 w-32 h-32 sm:w-48 sm:h-48 bg-green-500/10 rounded-lg transform rotate-12 blur-2xl" />
          ...
          >
            <div className="space-y-4">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold">
                Meet the <span className="text-yellow-300">Female Coach</span>
              </h2>
              <p className="text-lg sm:text-xl text-gray-200">
            ...
            <div className="flex items-center space-x-4">
              <div className="h-1 w-12 bg-yellow-300"></div>
              <span className="text-yellow-300 font-semibold">Trailblazer</span>
            </div>
          </motion.div>
        </div>
